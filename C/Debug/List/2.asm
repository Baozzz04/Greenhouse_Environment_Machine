...
; 0000 0084 ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 0085 SFIOR=(0<<ACME);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 0086 
; 0000 0087 // ADC initialization
; 0000 0088 // ADC disabled
; 0000 0089 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 008A 
...
; 0000 0091 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0092 
; 0000 0093 // Graphic Display Controller initialization
; 0000 0094 // The PCD8544 connections are specified in the
; 0000 0095 // Project|Configure|C Compiler|Libraries|Graphic Display menu:
; 0000 0096 // SDIN - PORTC Bit 3
; 0000 0097 // SCLK - PORTC Bit 4
; 0000 0098 // D /C - PORTC Bit 2
; 0000 0099 // /SCE - PORTC Bit 1
; 0000 009A // /RES - PORTC Bit 0
; 0000 009B 
...
; 0000 00A3 glcd_init_data.writexmem=NULL;
	STD  Y+4,R30
	STD  Y+4+1,R30
; 0000 00A4 // Set the LCD temperature coefficient
; 0000 00A5 glcd_init_data.temp_coef=80;
	LDD  R30,Y+6
	ANDI R30,LOW(0xFC)
	STD  Y+6,R30
; 0000 00A6 // Set the LCD bias
; 0000 00A7 glcd_init_data.bias=2;
	ANDI R30,LOW(0xE3)
	ORI  R30,8
	STD  Y+6,R30
; 0000 00A8 // Set the LCD contrast control voltage VLCD
; 0000 00A9 glcd_init_data.vlcd=50;
	LDD  R30,Y+7
	ANDI R30,LOW(0x80)
	ORI  R30,LOW(0x32)
	STD  Y+7,R30
...
; 0000 00AB glcd_init(&glcd_init_data);
	MOVW R26,R28
	RCALL _glcd_init
; 0000 00AC   glcd_putimagef(0,0,z,0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	ST   -Y,R30
	LDI  R30,LOW(_z*2)
...
; 0000 00AE {
; 0000 00AF 
; 0000 00B0         glcd_setfont(new_font);
	LDI  R30,LOW(_new_font*2)
	LDI  R31,HIGH(_new_font*2)
	CALL SUBOPT_0x0
; 0000 00B1         glcd_outtextxy(3,7,"00");
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R30,LOW(7)
	ST   -Y,R30
...
; 0000 00B2 //        glcd_outtextxy(5,7,"00");
; 0000 00B3 //        glcd_outtextxy(5,7,"00");
; 0000 00B4 //        glcd_outtextxy(5,7,":;");
; 0000 00B5         delay_ms(2000);
	LDI  R26,LOW(2000)
	LDI  R27,HIGH(2000)
	CALL _delay_ms
; 0000 00B6 }
