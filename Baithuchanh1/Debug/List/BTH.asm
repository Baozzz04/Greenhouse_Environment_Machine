...
_new_font:
	.DB  0x6,0x9,0x30,0xC,0xFE,0xFF,0x83,0x83
	.DB  0xFF,0xFE,0x0,0x1,0x1,0x1,0x1,0x0
	.DB  0x84,0x86,0xFF,0xFF,0x80,0x80,0x1,0x1
	.DB  0x1,0x1,0x1,0x1,0x86,0xC7,0xE3,0xB3
	.DB  0x9F,0x8E,0x1,0x1,0x1,0x1,0x1,0x1
	.DB  0xC6,0xC7,0x93,0x93,0xFF,0xFE,0x0,0x1
	.DB  0x1,0x1,0x1,0x0,0x3F,0x3F,0x30,0x30
	.DB  0xFC,0xFC,0x0,0x0,0x0,0x0,0x1,0x1
	.DB  0xDF,0xDF,0x9B,0x9B,0xFB,0xF3,0x0,0x1
	.DB  0x1,0x1,0x1,0x0,0xFE,0xFF,0xB3,0xB3
	.DB  0xF7,0xE6,0x0,0x1,0x1,0x1,0x1,0x0
	.DB  0x3,0x3,0xE3,0xFB,0x1F,0x7,0x0,0x0
	.DB  0x1,0x1,0x0,0x0,0xFE,0xFF,0x93,0x93
	.DB  0xFF,0xFE,0x0,0x1,0x1,0x1,0x1,0x0
	.DB  0xCE,0xDF,0x9B,0x9B,0xFF,0xFE,0x0,0x1
	.DB  0x1,0x1,0x1,0x0,0xFF,0xFF,0x80,0x80
	.DB  0x80,0x80,0x1,0x1,0x1,0x1,0x1,0x1
	.DB  0xFF,0xFF,0x38,0x38,0xFF,0xFF,0x1,0x1
	.DB  0x0,0x0,0x1,0x1
__glcd_mask:
...
; 0000 0028 // Variable used to store graphic display
; 0000 0029 // controller initialization data
; 0000 002A GLCDINIT_t glcd_init_data;
; 0000 002B 
...
; 0000 0090 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0091 
; 0000 0092 // Graphic Display Controller initialization
; 0000 0093 // The PCD8544 connections are specified in the
; 0000 0094 // Project|Configure|C Compiler|Libraries|Graphic Display menu:
; 0000 0095 // SDIN - PORTC Bit 3
; 0000 0096 // SCLK - PORTC Bit 4
; 0000 0097 // D /C - PORTC Bit 0
; 0000 0098 // /SCE - PORTC Bit 1
; 0000 0099 // /RES - PORTC Bit 2
; 0000 009A 
; 0000 009B // Specify the current font for displaying text
; 0000 009C glcd_init_data.font=font5x7;
	LDI  R30,LOW(_font5x7*2)
	LDI  R31,HIGH(_font5x7*2)
	ST   Y,R30
	STD  Y+1,R31
; 0000 009D // No function is used for reading
; 0000 009E // image data from external memory
; 0000 009F glcd_init_data.readxmem=NULL;
	LDI  R30,LOW(0)
	STD  Y+2,R30
	STD  Y+2+1,R30
; 0000 00A0 // No function is used for writing
; 0000 00A1 // image data to external memory
; 0000 00A2 glcd_init_data.writexmem=NULL;
	STD  Y+4,R30
	STD  Y+4+1,R30
; 0000 00A3 // Set the LCD temperature coefficient
; 0000 00A4 glcd_init_data.temp_coef=PCD8544_DEFAULT_TEMP_COEF;
	LDD  R30,Y+6
	ANDI R30,LOW(0xFC)
	STD  Y+6,R30
; 0000 00A5 // Set the LCD bias
; 0000 00A6 glcd_init_data.bias=PCD8544_DEFAULT_BIAS;
	ANDI R30,LOW(0xE3)
	ORI  R30,LOW(0xC)
	STD  Y+6,R30
; 0000 00A7 // Set the LCD contrast control voltage VLCD
; 0000 00A8 glcd_init_data.vlcd=PCD8544_DEFAULT_VLCD;
	LDD  R30,Y+7
	ANDI R30,LOW(0x80)
	ORI  R30,LOW(0x32)
	STD  Y+7,R30
...
; 0000 00AA glcd_init(&glcd_init_data);
	MOVW R26,R28
	RCALL _glcd_init
; 0000 00AB       glcd_putimagef(0,0,z,0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	ST   -Y,R30
	LDI  R30,LOW(_z*2)
...
_0x3:
; 0000 00AE       {
; 0000 00AF       glcd_setfont(new_font);
	LDI  R30,LOW(_new_font*2)
	LDI  R31,HIGH(_new_font*2)
	CALL SUBOPT_0x0
; 0000 00B0       glcd_outtextxy(5, 7, "00");
	LDI  R30,LOW(5)
	ST   -Y,R30
	LDI  R30,LOW(7)
	ST   -Y,R30
