...
; 0000 0039 // Variable used to store graphic display
; 0000 003A // controller initialization data
; 0000 003B GLCDINIT_t glcd_init_data;
; 0000 003C 
...
;	glcd_init_data -> Y+0
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 0041 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=P Bit0=T
; 0000 0042 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (1<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(2)
	OUT  0x1B,R30
; 0000 0043 
...
; 0000 00A4 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 00A5 
; 0000 00A6 // Graphic Display Controller initialization
; 0000 00A7 // The PCD8544 connections are specified in the
; 0000 00A8 // Project|Configure|C Compiler|Libraries|Graphic Display menu:
; 0000 00A9 // SDIN - PORTC Bit 3
; 0000 00AA // SCLK - PORTC Bit 4
; 0000 00AB // D /C - PORTC Bit 0
; 0000 00AC // /SCE - PORTC Bit 1
; 0000 00AD // /RES - PORTC Bit 2
; 0000 00AE 
; 0000 00AF // Specify the current font for displaying text
; 0000 00B0 glcd_init_data.font=font5x7;
	LDI  R30,LOW(_font5x7*2)
	LDI  R31,HIGH(_font5x7*2)
	ST   Y,R30
	STD  Y+1,R31
; 0000 00B1 // No function is used for reading
; 0000 00B2 // image data from external memory
; 0000 00B3 glcd_init_data.readxmem=NULL;
	LDI  R30,LOW(0)
	STD  Y+2,R30
	STD  Y+2+1,R30
; 0000 00B4 // No function is used for writing
; 0000 00B5 // image data to external memory
; 0000 00B6 glcd_init_data.writexmem=NULL;
	STD  Y+4,R30
	STD  Y+4+1,R30
; 0000 00B7 // Set the LCD temperature coefficient
; 0000 00B8 glcd_init_data.temp_coef=PCD8544_DEFAULT_TEMP_COEF;
	LDD  R30,Y+6
	ANDI R30,LOW(0xFC)
	STD  Y+6,R30
; 0000 00B9 // Set the LCD bias
; 0000 00BA glcd_init_data.bias=PCD8544_DEFAULT_BIAS;
	ANDI R30,LOW(0xE3)
	ORI  R30,LOW(0xC)
	STD  Y+6,R30
; 0000 00BB // Set the LCD contrast control voltage VLCD
; 0000 00BC glcd_init_data.vlcd=PCD8544_DEFAULT_VLCD;
	LDD  R30,Y+7
	ANDI R30,LOW(0x80)
	ORI  R30,LOW(0x32)
	STD  Y+7,R30
; 0000 00BD 
; 0000 00BE glcd_init(&glcd_init_data);
	MOVW R26,R28
	RCALL _glcd_init
; 0000 00BF 
; 0000 00C0 while (1)
